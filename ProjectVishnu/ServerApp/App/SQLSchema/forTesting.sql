...
CREATE TABLE OBRA (
	...
	constraint chk_Estado CHECK(
		Estado IN('completada', 'em-curso', 'por-comecar')
	)
);
...
INSERT INTO
	CONTA (Username, TipoDeUser, PasswordHash, PasswordSalt)
values
	(
		'admin',
		1,
		'0863F757E0EC7471A223B14B977F9D6158F2AEFFAAE255BFCDE5D188BCCAC825'
	);