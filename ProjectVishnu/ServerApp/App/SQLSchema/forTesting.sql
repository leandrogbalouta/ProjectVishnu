...
CREATE TABLE FUNCIONARIOS_OBRAS(
	...
	DataFim date,
	/* se a data estiver a null sinaliza que é a obra onde o funcionário se encontra atualmente.*/
...
INSERT INTO
	CATEGORIAS_PROFISSIONAIS (codigo, nomenclatura)
values
...
INSERT INTO
	MERCADO (mercadoName, sigla, dia_inicio, dia_fim)
values
	('portugal', 'PT', 21, 20),
	('espanha', 'ES', 26, 25),
	('franca', 'FR', 21, 20);
...
INSERT INTO
	FUNCIONARIOS_OBRAS (funcionario, obra, datacomeco, datafim)
values
	('234567899', 'OB22PT01', '2022-05-21', null),
	('255896379', 'OB22PT01', '2022-05-21', null);

INSERT INTO
	DIA_TRABALHO (funcionario, codigoobra, dia, horas, mes, ano, valor)
values
...
INSERT INTO
	SALARIO_FINAL (funcionario, mes, ano, valorfinal, valorapagar)
values
	('234567899', '06', '2022', 999, 999);

INSERT INTO
	FOLHA_DE_PONTO (mes, ano, obra, mercado)
values
...
INSERT INTO
	FOLHAS_SALARIO (id_salario, id_folha_de_ponto)
values
	(1, 6);
